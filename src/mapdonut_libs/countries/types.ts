...
export type Mapdonut_Country_Code = typeof CountryCodeList[number]
...
export type translations_dictionary = {
  [key in Mapdonut_country_available_translations]: string
}
...
export interface Mapdonut_Raw_Countrie {
  flag: string,
  currency: Mapdonut_Currency_Code[],
  callingCode: CallingCode[],
  name: { [key in TranslationLanguageCode]: string }
  cca2: Mapdonut_Country_Code
}

export interface Mapdonut_Country {
  name: string,
  currency: Mapdonut_Currency_Code[]
  callingCode: CallingCode[]
  cca2: Mapdonut_Country_Code,
  ccode?: string,
  flag: string,
  //translations: Mapdonut_Country_translation[],
...
export const mapdonut_country_available_translations = [
  'en',
  'cs',
  'cy',
  'de',
...
export type Mapdonut_country_available_translations = typeof mapdonut_country_available_translations[number];
