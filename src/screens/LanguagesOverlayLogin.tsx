...
const selectorShow = createCachedSelector((p: any) => p.show, show => show)(
  () => 'LangLoginOverlay',
);
...
function LanguagesOverlayLogin(props: any) {
  ...
  useEffect(() => {
    if (bs.current) {
      bs.current.snapTo(props.show ? 0 : 1);
    }
  }, [props.show]);
      ...
      <Button
        ...
        <Animated.View
          style={{
            ...
            opacity: runTiming(clock2, show ? 0 : 0.4, show ? 0.4 : 0, 400),
          }}
        />
      </Button>
    </Animated.View>
